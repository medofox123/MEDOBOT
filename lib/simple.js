	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            ...
            newsletterName: '𝑆𝑈𝑃𝑃𝑂𝑅𝑇 𝐹𝑂𝑋 𝐵𝑂𝑇', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363334163906836@newsletter", "120363334163906836@newsletter", "120363334163906836@newsletter", "120363334163906836@newsletter", "120363334163906836@newsletter"]
let canalNombre = ["𝑆𝑈𝑃𝑃𝑂𝑅𝑇 𝐹𝑂𝑋 𝐵𝑂𝑇 ", "𝑆𝑈𝑃𝑃𝑂𝑅𝑇 𝐹𝑂𝑋 𝐵𝑂𝑇", "𝑆𝑈𝑃𝑃𝑂𝑅𝑇 𝐹𝑂𝑋 𝐵𝑂𝑇", "𝑆𝑈𝑃𝑃𝑂𝑅𝑇 𝐹𝑂𝑋 𝐵𝑂𝑇"]
