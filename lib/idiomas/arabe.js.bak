...
const smsAvisoAG = () => { return `⚠*تــــنـبــــيه بـسـيط*⚠️\n\n` }
const smsAvisoIIG = () => { return `〘*معلومة*〙\n\n` }
const smsAvisoFG = () => { return `❌*خطأ*❌\n\n` }
const smsAvisoMG = () => { return `*مــــش صـح كــــدا*🙄\n\n` }
const smsAvisoEEG = () => { return `📩*أبلغ عن*📩\n\n` }
const smsAvisoEG = () => { return `💚*مـبـسـوط مـــــنــــــگ*💚\n\n` }
...
const smsUnreg = () => { return `\`\`\`❃━═━═✦•〘📝〙•✦═━═━❃\n أنـت لــــسـه جـديـــــــد فـي الـــــبوت الــــࢪجــاء التــــسجــيل في الـــخـدمه \n للــتــسجـيل اكــتـــب #تسجيل\n ❃━═━═✦•〘📝〙•✦═━═━❃\`\`\`` }
const smsRestrict = () => { return `\`\`\`الأمࢪ ده بـتاع المـطوࢪ بس\`\`\`` }
...
const smsLista1 = () => { return `🌟 معلومات 𝐹𝛩𝑋 𝑊𝐴 𝐵𝛩𝑇 🌟`}
...
const smsLista7 = () => { return `🦊 تثبيت 𝐹𝛩𝑋 𝑊𝐴 𝐵𝛩𝑇 🦊`}
...
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *الــــمـࢪكـب اللـي تـــودي* 😎\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
const smsSpromote = () => { return '*@user أنت الان ادمـن الجـــــࢪوب*'}
...
//_allantilink.js
const smsTextoYT = () => { return '🦊 ممتاز 𝐹𝛩𝑋 𝑊𝐴 𝐵𝛩𝑇 - WhatsApp '}
...
const smsCont18 = () => { return `*غير مصرح بها في هذا البوت لذلك *\n\n*اعتزر سأقوم بحظرك لانك تخالف الشروط والقوانين مع الســـلامه👋🏻*`}
...
//نص
const smsConMenu = () => { return `الــقـائــــمـه`}
...
const eGataCoins = () => { return '🦊 FOXCoins' }
const eGataTickers = () => { return '🎫 𝐹𝛩𝑋 Tickers' } 
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام 𝐹𝛩𝑋 𝑊𝐴 𝐵𝛩𝑇`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام 𝐹𝛩𝑋 𝑊𝐴 𝐵𝛩𝑇 في المجموعات`}
...
const smsGrupoTime4 = () => { return 'اغـــــلاق الــجࢪوب'}
const smsGrupoTime5 = () => { return 'فــــتح الجـــــــروب'}
const smsGrupoTime6 = () => { return 'الـمده'}
...
const smsJBInfo2 = () => { return `💖 *الوظيفة مستقرة ، إذا واجهت أي إزعاج ، فاتصل بالبريد: meddofox@gmail.com*\n💝 *يمكنك تقديم تبرع طوعي عن طريق PayPal: ${global.paypal}*\n\n*شكرا جزيلا على الدعم ${global.packname}*`}
...
const smsConj = () => { return `اقــتبـاسـات اكــتࢪ`}
...
const smsContacto4 = () => { return 'جهة اتصال 𝐹𝛩𝑋 𝑊𝐴 𝐵𝛩𝑇 الرسمية 🦊'}
