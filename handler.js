...
if (!('role' in user)) user.role = '*مـسـتـجد*'
...
this.sendMessage(m.chat, {text: `FOX coins 😂😍`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝗙𝗢𝗫 𝗪𝗛𝗔𝗧"𝗦𝗔𝗣𝗣 𝗕𝗢𝗧 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝗙𝗢𝗫 𝗪𝗛𝗔𝗧"𝗦𝗔𝗣𝗣 𝗕𝗢𝗧 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
//this.reply(m.chat, `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`, m)
continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont9']()} *${plugin.level}* ${lenguajeGB['smsCont10']()} *${_user.level}* ${lenguajeGB['smsCont11']()} *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝗙𝗢𝗫 𝗪𝗛𝗔𝗧"𝗦𝗔𝗣𝗣 𝗕𝗢𝗧 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
...
if (db.data.chats[m.chat].reaction && m.text.match(/(ción|dad|فوكس|oso|izar|mente|pero|tion|age|ous|ate|and|but|ify)/gi)) {
...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '🦊 𝐹𝛩𝑋 𝑊𝐴 𝐵𝛩𝑇 🦊') :
...
"thumbnail": apii.data, 
"title": [wm, '🦊 𝑆𝑢𝑝𝑒𝑟 ' + gt + ' 🦊', '⚡ 𝑀𝑒𝑑𝑜𝐻𝑎𝑐𝑘𝑒𝑟𝑧@𝑔𝑚𝑎𝑖𝑙.𝑐𝑜𝑚'].getRandom(),
"containsAutoReply": true,
"mediaType": 1, 
sourceUrl: 'https://github.com/medofox123' }}}, { quoted: fkontak2 })
apii.data = ''
...
if (groupUpdate.revoke) text = (chats.sRevoke || this.sRevoke || conn.sRevoke || '```لــينـك الـجـࢪوب اتـــغـيࢪ```\n@revoke').replace('@revoke', groupUpdate.revoke)
if (!text) continue
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '🦊 𝑆𝑢𝑝𝑒𝑟 ' + gt + ' 🦊', '⚡ 𝑀𝑒𝑑𝑜𝐻𝑎𝑐𝑘𝑒𝑟𝑧@𝑔𝑚𝑎𝑖𝑙.𝑐𝑜𝑚'].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
