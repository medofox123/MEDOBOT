...
await conn.sendMessage(m.chat, { text: `*مـش الادمن قالك مـفـيش لـينكات مـش بتسمع الكلام لــيه اهو طـــردك زي الــــكلب سلام 👋* *${user}*`, mentions: [m.sender] }, { quoted: m })    
