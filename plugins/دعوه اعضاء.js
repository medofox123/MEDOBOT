...
await conn.reply(text+'@s.whatsapp.net', `*مــࢪحبا انـا ادعـي 𝐹𝛩𝑋 انـا بوت واتساب اعمل ب الذكاء الاصطناعي قام احد المشرفين بطلب مني دعوتك للإنضمام لهذه المجموعه*\n\n${link}`, m, {mentions: [m.sender]})
m.reply(`*@${who.split`@`[0]}*\n*جـــار الإࢪســـــــال.....*`) 
}
